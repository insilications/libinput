...
Version  : 1.17.901
Release  : 501
URL      : file:///aot/build/clearlinux/packages/libinput/libinput-v1.17.901.tar.gz
Source0  : file:///aot/build/clearlinux/packages/libinput/libinput-v1.17.901.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622246009
...
meson --libdir=lib64 --prefix=/usr --buildtype=release -Ddefault_library=both -Dlibwacom=false \
